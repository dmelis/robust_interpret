...
from robust_interpret.utils import generate_dir_names, plot_attribution_stability
...
def main():
    ...
    model_path, log_path, results_path = generate_dir_names(
        'cifar', args, make=not args.debug)
    (x_train, y_train), (x_test, y_test), y_train_hot, y_test_hot = load_cifar10_data()
    ...
    x = x_test[1]
    plot_attribution_stability(model, explainer_dict, x, noise_level=.1,
